...
export const metadata = {
  title: 'Políticas de Privacidad - Mtriq.app',
  description: 'Políticas de Privacidad y Tratamiento de Datos del software para restaurantes Mtriq.app.',
};
        ...
        <div className="space-y-8 text-zinc-400 text-sm md:text-base leading-relaxed border-t border-white/5 pt-8">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-2 text-zinc-400">
              ...
              <li>Enviar recibos de pago digitales y facturas por la suscripción mensual de Mtriq a la cuenta del gerente.</li>
            </ul>
          </section>
